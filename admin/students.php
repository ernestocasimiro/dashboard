...
if (isset($_SESSION['id']) && isset($_SESSION['role'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $dataa = $_POST['dataa'];
        $numbi = $_POST['numbi'];
        $foto_bi1 = $_POST['foto_bi1'];
        $foto_bi2 = $_POST['foto_bi2'];
        ...
        $query = mysqli_query($con, "INSERT INTO students (fname, lname, genero, dataa, numbi, foto_bi1, foto_bi2, endereco, fotoperfil, turma, escola, telefone, email, encarregado, password) 
        VALUES ('$fname', '$lname', '$genero', '$dataa', '$numbi', '$foto_bi1', '$foto_bi2', '$endereco', '$fotoperfil', '$turma', '$escola', '$telefone', '$email', '$encarregado', '$password')");

        if ($query) {
            echo "<script>alert('Aluno adicionado com sucesso!');</script>";
        } else {
            echo "<script>alert('Erro ao adicionar aluno.');</script>";
        }
...
<body>
  ...
  <!-- Modal para adicionar/editar alunos - Optimized -->
            ...
            <form id="student-form" enctype="multipart/form-data" method="POST" action="students.php">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        <label for="student-name">Primeiro Nome <span class="required">*</span></label>
                        <input type="text" id="student-name" placeholder="Primeiro Nome" name="fname" required><br><br>
                        <label for="student-name">Sobrenome <span class="required">*</span></label>
                        <input type="text" id="student-name" placeholder="Sobrenome" name="lname" required>
                    </div>
                    <div class="form-row">
                        <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="bi-number" placeholder="Ex: 0000000LA000" name="numbi" required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="student-address" rows="2" placeholder="Endereço completo do aluno" name="endereco" required></textarea>
                    </div>

                    <!-- Corrigido: Fotografia de Perfil -->
                    <div class="form-group">
                        <label for="student-photo">Fotografia de Perfil <span class="required">*</span></label>
                        <div class="file-upload">
                        ...
                        <small class="form-hint">Adicione uma foto de rosto clara do aluno (formato JPG ou PNG)</small>
                    </div>
                </fieldset>
                ...
                <fieldset>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="previous-school" name="escola" placeholder="Ex: Colégio Pitruca">
                        </div>
                    </div>
                </fieldset>
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        <label for="student-contact">Número de Contato <span class="required">*</span></label>
                        <div class="phone-input-container">
                            ...
                            <input type="tel" id="student-contact" name="telefone" placeholder="XXX XXX XXX" required>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="student-email" name="email" placeholder="exemplo@email.com" required>
                    </div>
                </fieldset>
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        <label for="parents">Selecionar Encarregado</label>
                        <select id="parents" name="encarregado" onchange="setSelectedParent(this.value)">
                            <option value="">Selecione um encarregado</option>
                            <option value="1">João Silva (Pai)</option>
                            <option value="2">Maria Oliveira (Mãe)</option>
                            <option value="3">António Santos (Tio)</option>
                        </select>
                        <small class="form-hint">Selecione um encarregado existente</small>
                    </div>
                </fieldset>
                ...
                <div class="form-actions">
                    <button type="button" class="cancel-btn" id="cancel-student-btn">Cancelar</button>
                    <button type="submit" name="submit" class="save-btn">Salvar Aluno</button>
                </div>
            </form>
        </div>
    </div>
