            ...
            <form id="teacher-form">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="teacher-name" placeholder="Nome completo do aluno" required>
                    </div>
                    <div class="form-row">
                        <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="teacher-address" rows="2" placeholder="Endereço completo do aluno" required></textarea>
                    </div>
                </fieldset>
                ...
                <fieldset>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label for="teacher-class">Turma <span class="required">*</span></label>
                        ...
                        <div class="form-group">
                            <label for="teacher-class">Disciplinas <span class="required">*</span></label>
                            <select id="teacher-class" required>
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="teacher-email" placeholder="exemplo@email.com" required>
                    </div>
                </fieldset>
