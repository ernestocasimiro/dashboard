...
function loadMockData() {
    ...
    if (studentTableBody) {
        const studentsData = [
            { id: 'STU001', name: 'João Silva', class: 'Turma 10ª A Informática', gender: 'Masculino', contact: '+244 923 456 789', attendance: '95%' },
            { id: 'STU002', name: 'Maria Santos', class: 'Turma 10ª A Informática', gender: 'Feminino', contact: '+244 923 456 790', attendance: '98%' },
            { id: 'STU003', name: 'Pedro Oliveira', class: 'Turma 10ª B Informática', gender: 'Masculino', contact: '+244 923 456 791', attendance: '85%' },
            { id: 'STU004', name: 'Ana Costa', class: 'Turma 10ª A Informática', gender: 'Feminino', contact: '+244 923 456 792', attendance: '92%' },
            { id: 'STU005', name: 'Carlos Ferreira', class: 'Turma 11ª Informática', gender: 'Masculino', contact: '+244 923 456 793', attendance: '90%' }
        ];
        
        studentTableBody.innerHTML = studentsData.map(student => `
            <tr>
                <td>${student.id}</td>
                <td>${student.name}</td>
                <td>${student.class}</td>
        ...
        addActionButtonListeners('student');
    }
    ...
    if (attendanceTableBody) {
        const attendanceData = [
            { id: 'STU001', name: 'João Silva', class: 'Turma 10ª Informática A', date: '01/04/2025', status: 'present', notes: '-' },
            { id: 'STU002', name: 'Maria Santos', class: 'Turma 10ª Informática A', date: '01/04/2025', status: 'present', notes: '-' },
            { id: 'STU003', name: 'Pedro Oliveira', class: 'Turma 10ª Informática B', date: '01/04/2025', status: 'absent', notes: 'Doente' },
            { id: 'STU004', name: 'Ana Costa', class: 'Turma 10ª Informática A', date: '01/04/2025', status: 'late', notes: 'Chegou 15 minutos atrasado' },
            { id: 'STU005', name: 'Carlos Ferreira', class: 'Turma 11ª Informática', date: '01/04/2025', status: 'present', notes: '-' }
        ];
